...
sed -i -e "s/^\# broadcast_rpc_address: 1.2.3.4/broadcast_rpc_address: $IP/" $CASSANDRA_CONFIG/cassandra.yaml
...
sed -i -e "s/- seeds: \"127.0.0.1\"/- seeds: \"$IP,$CASSANDRA_SEEDS\"/" $CASSANDRA_CONFIG/cassandra.yaml
...
cp /etc/cassandra/cassandra.yml /prueba
